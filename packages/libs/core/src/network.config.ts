...
const configs: Record<Network, NetworkConfig> = {
  [Network.alfajores]: {
    relayers: [
      ...
      {
        externalAccount: "0xb04390478A57E3C2147599D5380434f25fa5234d",
        metaTransactionWallet: "0x4D9a25EC8A9E80295262d49f85B3D35D6b8dc823"
      }
    ],
    contracts: {
  ...
  [Network.rc1]: {
    relayers: [
      ...
      {
        externalAccount: "0x198e0D8601AB509ABf1B0B99Fd8f234583Ef1309",
        metaTransactionWallet: "0x95E381523ab6B566e20D56870cB9f00864F04220",
      },
      {
        externalAccount: "0xbDD68B64e288171B37F01346042BEe6Eb7dFAE4f",
        metaTransactionWallet: "0xF696152400FC3BFC96a793263c0B0b91E7153EC1",
      }
    ],
    contracts: {
      MetaTransactionWalletVersions: {
