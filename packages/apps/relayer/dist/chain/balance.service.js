...
var BalanceService = (function () {
    function BalanceService(kit, logger, walletCfg, metaTxWallet) {
        this.kit = kit;
        this.logger = logger;
        this.walletCfg = walletCfg;
        this.metaTxWallet = metaTxWallet;
    }
    BalanceService.prototype.onModuleInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this;
                        return [4, this.kit.contracts.getStableToken()];
                    case 1:
                        _a.cUSD = _c.sent();
                        _b = this;
                        return [4, this.kit.contracts.getGoldToken()];
                    case 2:
                        _b.celo = _c.sent();
                        return [4, this.logBalance()];
                    case 3:
                        _c.sent();
                        return [2];
                }
    ...
    BalanceService.prototype.logBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var cUSDBalance, celoBalance, exp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.cUSD.balanceOf(this.metaTxWallet.address)];
                    case 1:
                        cUSDBalance = _a.sent();
                        return [4, this.celo.balanceOf(this.walletCfg.address)];
                    case 2:
                        celoBalance = _a.sent();
                        exp = new bignumber_js_1.default(10).pow(18);
                        this.logger.event(logger_1.EventType.RelayerBalance, {
    ...
    BalanceService = __decorate([
        ...
        __metadata("design:paramtypes", [contractkit_1.ContractKit,
            logger_1.KomenciLoggerService, Object, MetaTransactionWallet_1.MetaTransactionWalletWrapper])
    ], BalanceService);
