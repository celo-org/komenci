...
exports.appConfig = config_1.registerAs('app', function () {
    return {
        ...
        gasPriceUpdateIntervalMs: parseInt(process.env.GAS_PRICE_UPDATE_INTERVAL_MS, 10) || 5000,
        gasPriceMultiplier: parseFloat(process.env.GAS_PRICE_MULTIPLIER) || 5,
        gasPriceFallback: process.env.GAS_PRICE_FALLBACK || "1000000000",
        maxGasPrice: process.env.MAX_GAS_PRICE || "100000000000",
        odisTimeoutMs: parseInt(process.env.ODIS_TIMEOUT_MS, 10) || 10000,
    };
});
